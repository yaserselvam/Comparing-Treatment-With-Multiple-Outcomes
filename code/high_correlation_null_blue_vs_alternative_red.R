...
alt_data <- data.frame(theta1 = rnorm(1000, 2), theta2 = rnorm(1000, 2), group = "Alternative")
...
ggplot(data, aes(x = theta1, y = theta2, color = group)) +
  ...
  labs(title = "High Correlation: Null (blue) vs. Alternative (red)",
       subtitle = "Type I Error: 0.0997 | Type II Error: 0.8391",
       x = "θ_1",
       y = "θ_2") +
  theme_minimal()
